...
pygame.display.set_caption("DHOOM5")
...
intro_background=pygame.image.load("background.jpeg")
instruction_background=pygame.image.load("background2.jpeg")
pygame.mixer.music.load("ChalaJatahu.mp3")
